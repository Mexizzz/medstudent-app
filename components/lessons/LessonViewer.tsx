  ...
  return (
    <div className="space-y-6 pb-10">
      ...
      <div className="text-center space-y-3 pb-6 border-b border-border">
        ...
        <p className="text-muted-foreground text-sm max-w-2xl mx-auto leading-relaxed">{lesson.overview}</p>
      </div>
        ...
        <div key={i} className="bg-card rounded-2xl border border-border shadow-sm overflow-hidden">
          ...
          {section.imageUrl ? (
            <div className="relative border-b border-border bg-card">
              ...
              />
              <span className="absolute bottom-2 right-3 flex items-center gap-1 text-[10px] text-muted-foreground bg-card/80 px-2 py-0.5 rounded-full border border-border">
                <Globe className="w-2.5 h-2.5" /> Web
              </span>
            </div>
          ) : section.svgCode ? (
            <div className="p-5 bg-amber-50/40 border-b border-border">
          ...
          {(section.chatImageUrl || section.chatSvgCode) && (
            <div className="border-b border-border bg-violet-50/30">
              ...
              <div className="px-5 pb-4">
                {section.chatImageUrl ? (
                  <div className="relative bg-card rounded-xl border border-violet-100 overflow-hidden">
                    <img
          ...
          <div className="px-6 py-5 space-y-4">
            <p className="text-muted-foreground text-sm leading-relaxed">{section.explanation}</p>
