...
const plans = [
  {
    ...
    features: [
      ...
      { name: 'Timed Exam Mode', included: false },
      { name: 'AI Answer Explanations', included: false },
      { name: 'Weekly Study Insights', included: false },
      { name: 'Room Challenges', included: false },
      { name: 'Weak Topic Auto-Quiz', included: false },
      { name: 'Custom Themes', included: false },
      { name: 'PDF / Notes Export', included: false },
    ],
  },
  {
    id: 'pro' as Tier,
    ...
    features: [
      ...
      { name: 'Timed Exam Mode', value: 'Yes', included: true },
      { name: 'AI Answer Explanations', value: 'Yes', included: true },
      { name: 'Weekly Study Insights', value: 'Yes', included: true },
      { name: 'Room Challenges', value: 'Yes', included: true },
      { name: 'Clinical Cases', included: false },
      { name: 'Exam Lab', included: false },
      { name: 'Weak Topic Auto-Quiz', included: false },
      { name: 'Custom Themes', included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Weekly Study Insights', value: 'Yes', included: true },
      { name: 'Room Challenges', value: 'Yes', included: true },
      { name: 'Weak Topic Auto-Quiz', value: 'Yes', included: true },
      { name: 'Custom Themes', value: '6 themes', included: true },
      { name: 'PDF / Notes Export', value: 'Yes', included: true },
    ],
  },
];
